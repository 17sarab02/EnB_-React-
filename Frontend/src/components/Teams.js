    ...
    return (
        ...
        <Section lightDark={props.lightDark} backgroundSet={true} background={props.lightDark.tertiaryBackground}>
            <div className="sectionContainer">
                ...
                <div className="teamContainer">
                    <TeamMember member={JK} details = {{name: "J Krishnaiah", phone: "+91-9442544782", email: "krishnaiah@iiitk.ac.in"}}/>
                    <TeamMember member={VSRK} details = {{name: "VSR Krishnaiah", phone: "+91-9899750010", email: "vsrk@iiitk.ac.in"}}/>
                </div>
            </div>
        </Section>
        ...
        <Section lightDark={props.lightDark} backgroundSet={true} background={props.lightDark.tertiaryBackground}>
            <div className="sectionContainer">
                ...
                <div className="teamContainer">
                    <TeamMember member={Nishchala} details = {{name: "Nishchala M.", email: "120ec0044@iiitk.ac.in"}}/>
