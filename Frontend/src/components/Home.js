    ...
    return (
        <>
            ...
            <div className="sectionContainer">
                ...
                <img src={downArrow} style={{height: "75px"}} alt='DownArrow'></img>
            </div>
        </Section>
        <About lightDark={props.lightDark} />
        <Section lightDark={props.lightDark} backgroundSet={true} background={props.lightDark.secondaryBackground}>
            <div className="sectionContainer">
                <h1 id="TestimonialHeading" style={{margin: "0px"}}>Latest video</h1>
                <TestimonialCarousel lightDark={props.lightDark}/>
            </div>
        </Section>
        <Contact lightDark={props.lightDark} />
        </>
    );
}
